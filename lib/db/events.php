...
$observers = [
    ...
    // Course backup and course update.
    [
        'eventname'   => '*',
        'callback'    => 'core_course\eventobservers::course_updated',
    ],
    [
        'eventname'   => '\core\event\course_backup_created',
        'callback'    => 'core_course\eventobservers::course_backup_created',
    ],
    [
        'eventname'   => '\core\event\course_restored',
        'callback'    => 'core_course\eventobservers::course_restored',
    ],
];
