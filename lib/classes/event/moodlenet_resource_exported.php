...
class moodlenet_resource_exported extends \core\event\base {
    ...
    public static function get_name(): string {
        return get_string('eventresourceexported', 'moodlenet');
    }
    ...
    public function get_description() {
        ...
        $cmids = explode($this->other['cmids'], "', '");

        $description = "The user with id '{$this->userid}' {$outcome} activities with the following " .
            "course module ids, from context with id '{$this->data['contextid']}': '{$cmids}";
