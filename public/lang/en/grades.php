...
$string['enableoutcomes_help'] = 'If enabled, teachers can define learning outcomes for a course, tag activities to those outcomes, and view alignment coverage. Outcomes are independent of grading — a scale is optional.';
