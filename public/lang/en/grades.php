...
$string['enableoutcomes'] = 'Enable learning outcomes system';
$string['enableoutcomes_help'] = 'Master switch for the learning outcomes system. When off, all outcome-related links, forms, and reports are hidden site-wide. Turn this on before configuring any other learning outcomes settings.';
...
$string['learningoutcomes_bulkcreate_help'] = 'Enter one learning outcome per line using the format: Shortname | Full description';
$string['learningoutcomes_coursedefault'] = 'Enable learning outcomes for new courses by default';
$string['learningoutcomes_coursedefault_help'] = 'If enabled, learning outcomes will be turned on automatically for all newly created courses.';
$string['learningoutcomes_courseenabled'] = 'Enable learning outcomes for this course';
$string['learningoutcomes_courseenabled_help'] = 'When enabled, teachers can define learning outcomes for this course and tag activities to them.';
$string['learningoutcomes_enforcement'] = 'Enforcement mode';
$string['learningoutcomes_enforcement_hard'] = 'Hard (block visibility until minimum is met)';
$string['learningoutcomes_enforcement_help'] = 'Hard mode prevents a course from being made visible until the minimum number of learning outcomes is defined. Soft mode shows a warning but does not block saving.';
...
$string['noscales'] = 'No scales are available for this course. Would you like to add one?';
...
$string['outcomereport'] = 'Learning outcome report';
...
$string['outcomesstandardavailable'] = 'Available standard learning outcomes';
